        ...
        >
          ...
          {showMessage1 && (
            <div className="flex items-start gap-2">
              <div className="bg-gray-700/80 text-white py-2 px-3 rounded-lg rounded-tl-none max-w-[80%]">
                <div className="text-xs text-gray-300 mb-1">Scarlett</div>
                <p>If you were exposed to Paraquat and later diagnosed with Parkinson's disease, you may be eligible for compensation.</p>
              </div>
            </div>
          )}
          ...
          {showDiagnosisQuestion && (
            <div className="flex items-start gap-2">
              <div className="bg-gray-700/80 text-white py-2 px-3 rounded-lg rounded-tl-none max-w-[80%]">
                <div className="text-xs text-gray-300 mb-1">Scarlett</div>
                <p>Have you or someone close to you been diagnosed with Parkinson's after Paraquat exposure?</p>
          ...
          {showQualifiedIntro && (
            <div className="flex items-start gap-2">
              <div className="bg-gray-700/80 text-white py-2 px-3 rounded-lg rounded-tl-none max-w-[80%]">
                <div className="text-xs text-gray-300 mb-1">Scarlett</div>
                <p>You may be entitled to compensation for medical bills, lost income, and more — with no upfront legal fees.</p>
              </div>
            </div>
          )}
          ...
          {showNotQualifiedMessage1 && (
            <div className="flex items-start gap-2">
              <div className="bg-gray-700/80 text-white py-2 px-3 rounded-lg rounded-tl-none max-w-[80%]">
                <div className="text-xs text-gray-300 mb-1">Scarlett</div>
                <p>We're currently assisting individuals who have been diagnosed with Parkinson's disease after Paraquat exposure.</p>
              </div>
            </div>
          )}
          ...
          {showDeclinedMessage1 && (
            <div className="flex items-start gap-2">
              <div className="bg-gray-700/80 text-white py-2 px-3 rounded-lg rounded-tl-none max-w-[80%]">
                <div className="text-xs text-gray-300 mb-1">Scarlett</div>
                <p>If you or someone you know is impacted by Paraquat exposure, we're here to help.</p>
              </div>
            </div>
          )}
